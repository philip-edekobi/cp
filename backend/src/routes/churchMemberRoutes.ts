 ...
 * /member/{id}:
 *   get:
 *     summary: Gets a Church Member's details
 *     tags: [Church Member]
 *     responses:
 *       200:
 *         description: Church Member retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   example: null
 */
router.get("/:id", auth, getOneMember);

/**
 * @swagger
 * /member?parishAdminID={id}:
 *   get:
 *     summary: Gets all members in a Parish
 *     tags: [Church Member]
 *     responses:
 *       200:
 *         description: Church Members retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 *                            example: https://server.loc/img
 */
router.get("", auth, getAllMembersByParishAdmin);
